...
export default function ChangePasswordPage() {
  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center p-6">
      <div className="w-full max-w-md bg-surface-dark border border-white/5 rounded-2xl p-8 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.8)]">
        
        <div className="flex flex-col mb-8 text-center">
          <h1 className="text-xl font-bold text-white mb-2">Welcome!</h1>
          <p className="text-gray-400 text-xs leading-relaxed">
            For your security, please set a new password before accessing the admin console.
          </p>
        </div>
