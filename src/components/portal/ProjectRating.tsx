...
import { submitRating } from '@/app/portal/[slug]/actions' // I need to create this server action
...
export default function ProjectRating({ projectId }: { projectId: string }) {
  ...
  if (submitted) {
    return (
      <div className="bg-white border border-gray-200 rounded-2xl p-8 text-center mt-12 mb-8 relative overflow-hidden shadow-sm">
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-2xl p-8 mt-12 mb-8 shadow-sm">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">How was your experience?</h2>
        <p className="text-gray-500 text-sm">Your project is now marked as completed. We'd love to hear your feedback.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="max-w-xl mx-auto">
              ...
              <Star 
                className={`w-10 h-10 transition-colors ${
                  (hoverRating || rating) >= star 
                    ...
                    : 'text-gray-400 hover:text-gray-400-light'
                }`} 
              />
            </button>
          ))}
        ...
        <div className="space-y-4">
          ...
          <button 
            ...
            className="w-full bg-brand-primary hover:bg-brand-primary/90 text-white font-bold uppercase tracking-wider py-4 rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
